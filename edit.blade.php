            ...
            <div class="card-body">
                ...
                <div class=" form-group">
                    <select class="form-control" name="level">
                        ...
                        <option value="{{$v->id}}" @if($v->id == $User->level) selected="" @endif>Cấp bậc: {{$v->name}}
                        </option>
                        @endforeach
                        @endif
                    </select>
                ...
                <div class=" form-group">
                    <select class="form-control" name="status">
                        <option value="1" @if($User->status == 1) selected="" @endif>Trạng thái: Bật</option>
                        <option value="0" @if($User->status == 0) selected="" @endif>Trạng thái: Tắt</option>
                    </select>
                </div>
                ...
                <div class=" form-group">
                    ...
                    <p class="ad_note_password">Để trống trường này</p>
                </div>
